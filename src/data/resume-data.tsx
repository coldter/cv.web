...
export const RESUME_DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      bulletPoints: [
        "Engineered the backend for virtual card provisioning in Assure PAT, enabling test cards to be issued in under 30 seconds with support for 1,000+ reuses and automatic inventory return upon test completion.",
        "Integrated AWS KMS with a zero-knowledge design to ensure testers never access raw PAN or CVV data, enforcing encryption across all card lifecycle events and sensitive data flows.",
        "Built real-time APDU command capture and transaction logging pipelines for Assure PAT, enabling structured debugging workflows and significantly accelerating issue resolution turnaround.",
        "Implemented comprehensive audit logging across all card events, provisioning actions, and transactions, achieving full audit coverage for compliance, traceability, and certification workflows.",
        "Developed the pre-transaction rule enforcement engine for Ayris Pay, evaluating spending controls — including merchant category restrictions, geographic boundaries, and usage limits — before requests reach the payment network.",
        "Architected the shared card access backend for Ayris Pay, enabling cardholders to distribute spending access to family or team members while keeping primary card credentials fully isolated.",
        "Implemented data residency and localization controls to ensure transaction processing adhered to regional regulatory requirements across target markets.",
      ],
    },
    {
